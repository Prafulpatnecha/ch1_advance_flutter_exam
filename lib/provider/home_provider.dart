...
import 'package:ch1_advance_flutter_exam/controller/apihelper.dart';
...
class HomeProvider extends ChangeNotifier
{
  ...
  void addToCartMethod(int index,double price)
  {
  ...
  void totalCart()
  {
    ...
    for(int i=0;i<addList.length;i++)
      {
        // double.parse(addList[i].split(" ").sublist(1,2).join(" "));
